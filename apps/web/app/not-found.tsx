...
export default function NotFound() {
  return (
    <div className="py-28 text-center">
      ...
      <pre className="px-panel mx-auto mt-6 inline-block px-5 py-3 text-left text-[19px]"><span className="text-mint">$</span> npx tokseal login{'\n'}<span className="text-mint">$</span> npx tokseal submit</pre>
